...
class CustomerGallary extends StatefulWidget {
  const CustomerGallary({super.key});

  @override
  State<CustomerGallary> createState() => _CustomerGallaryState();
}

class _CustomerGallaryState extends State<CustomerGallary> {
  File? file;
